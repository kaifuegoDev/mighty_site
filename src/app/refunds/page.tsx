...
export default function Refunds() {
    return (
        <PolicyPage title="Refund Policy" lastUpdated="February 20, 2026">
            <h3 className="text-white text-xl font-bold mt-8 mb-4">1. Tournament Entry Fees</h3>
            <p>Entry fees are generally non-refundable once a tournament has started. If a tournament is cancelled by Mighty, a full refund will be issued to your wallet within 24 hours.</p>

            <h3 className="text-white text-xl font-bold mt-8 mb-4">2. Technical Issues</h3>
            <p>If you face technical issues preventing you from joining a match (server side), please contact support within 30 minutes of the match start time to be eligible for a refund credit.</p>

            <h3 className="text-white text-xl font-bold mt-8 mb-4">3. Withdrawal Policy</h3>
            <p>Winnings are credited to your Mighty wallet. Withdrawals to external payment methods (UPI, Bank) are processed within 5-15 minutes but may take up to 48 hours depending on banking partners.</p>

            <h3 className="text-white text-xl font-bold mt-8 mb-4">4. Dispute Resolution</h3>
            <p>Disputes regarding refunds or payouts must be raised via the "Connect" section with valid match screenshots or evidence. Our team reviews all disputes within 48 hours.</p>
        </PolicyPage>
    );
}
